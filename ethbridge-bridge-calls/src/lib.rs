...
#[doc = "Container type for all input parameters for the `transferToErc` function with signature `transferToErc(((address[],uint256[],uint256),(bytes32,bytes32,uint8)[],(address,address,uint256,bytes32)[],bytes32,bytes32[],bool[],uint256,string))` and selector `0xa08821dc`"]
#[derive(
    Clone,
    :: ethers_contract :: EthCall,
    :: ethers_contract :: EthDisplay,
...
#[ethcall(
    name = "transferToErc",
    abi = "transferToErc(((address[],uint256[],uint256),(bytes32,bytes32,uint8)[],(address,address,uint256,bytes32)[],bytes32,bytes32[],bool[],uint256,string))"
)]
