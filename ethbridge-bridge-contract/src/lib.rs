...
impl<M: ethers::providers::Middleware> Bridge<M> {
    ...
    #[doc = "Calls the contract's `transferToERC` (0x4a223ae1) function"]
    ...
    pub fn transfer_to_namada(
        &self,
        tranfers: ::std::vec::Vec<NamadaTransfer>,
        confirmations: ethers::core::types::U256,
    ) -> ethers::contract::builders::ContractCall<M, ()> {
        self.0
            .method_hash([7, 46, 119, 203], (tranfers, confirmations))
            .expect("method not found (this should never happen)")
    }
